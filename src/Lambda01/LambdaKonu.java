...
public class LambdaKonu {
    ...
    public static void main(String[] args) {
        //lambda (functional programing)                       - eskisi--> java (structured programing
        //1)nasil yaparim ne yapaprim sorulur?                 - ne yaparimdan cok nasil yapaarim diye dusunulur
        //2)kod kisaligi, kod okunurlugu, ve hatasiz            -kod genelde uzundur,baskasi sizin ne yaptiginizi
        // kod yazma bakimindan elverislidir                    anlayamayabilir
        //3)lambda sadece collections ve arraya de
